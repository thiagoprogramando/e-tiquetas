            ...
            <div class="layout-container">
                <nav class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme" id="layout-navbar">
                    <div class="container-xxl">
                                ...
                                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                                        <div class="avatar avatar-online">
                                            <img src="{{ Auth::user()->avatar ? asset('storage/'.Auth::user()->avatar) : asset('assets/img/avatars/man.png') }}" alt="Perfil de {{ Auth::user()->name }}" class="rounded-circle"/>
                                        </div>
                                    </a>
                        ...
                        <form action="{{ route('exports') }}" method="GET" class="navbar-search-wrapper search-input-wrapper container-xxl d-none">
                            @csrf
                            <input type="text" name="name" class="form-control search-input border-0" placeholder="Pesquisar..." aria-label="Pesquisar..." />
                                ...
                                <ul class="menu-inner justify-content-center">
                                    ...
                                    <li class="menu-item">
                                        <a href="javascript:void(0)" class="menu-link menu-toggle">
                                            ...
                                            <div data-i18n="Etiquetas">Etiquetas</div>
                                        </a>
                                        <ul class="menu-sub">
                                            <li class="menu-item">
                                                <a href="{{ route('layouts') }}" class="menu-link">
                                                    <div data-i18n="Templates">Templates</div>
                                                </a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="{{ route('exports') }}" class="menu-link">
                                                    <div data-i18n="Gerar Remessa">Gerar em Lote</div>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="menu-item">
                                        <a href="javascript:void(0)" class="menu-link menu-toggle">
                                            ...
                                            <div data-i18n="Base de Dados">Base de Dados</div>
                                        </a>
                                        <ul class="menu-sub">
                                            <li class="menu-item">
                                                <a href="{{ route('create-data') }}" class="menu-link">
                                                    <div data-i18n="Importar">Importar</div>
                                                </a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="{{ route('data') }}" class="menu-link">
                                                    <div data-i18n="Importados">Importados</div>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
